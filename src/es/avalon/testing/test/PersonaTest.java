...
public class PersonaTest {
    ...
    public void testComparacionPersonas(){
        ...
        Persona p1=new Persona("1","carmen", LocalDate.of(2000,10,10));
        Persona p2=new Persona("2","carlos", LocalDate.of(2010,10,10));
        Persona pNueva=new Persona("1","jorge", LocalDate.of(1980,10,10));
